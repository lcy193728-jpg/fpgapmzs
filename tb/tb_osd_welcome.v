...
//          BG(非OSD区背景保持)=244384 / 金底条混色=10764
//          / 欢迎语深字=2612(W_TITLE墨点653×4, 2×放大)
//          / 左卡藏蓝混色=10299 / 右卡藏蓝混色=10428(总量20727)
//          / 卡内白字=1513(821+692) / 左/右强调条各160
//          / 底部滚动流程亮橙=2986(W_FLOW墨点1493×2, 屏宽=两整周期)
//          / 暗带底=23894 / 背景透传=244384
...
module tb_osd_welcome;
    ...
    //   金底区=13376 - 欢迎语墨点 653×4=10764
    //   欢迎语字=2612 / 左卡强调=4×40=160 / 右卡强调=160
    //   左卡混色=11280-160-821=10299 / 右卡混色=11280-160-692=10428
    //   卡内白字=821+692=1513
    //   滚动橙=1493×2(屏宽=两整周期)=2986 / 暗带=42×640-2986=23894
    //   校验和=244384+10764+2612+160+160+10299+10428+1513+2986+23894
    //          =307200
    //================================================================
    localparam TOT_PIX  = H_ACT * V_ACT;                 // 307200
    localparam EX_BG    = 244384;
    localparam EX_GOLD  = 10764;
    localparam EX_TITLE = 2612;
    localparam EX_ACCL  = 160;
    localparam EX_ACCR  = 160;
    localparam EX_CARD  = 10299 + 10428;                 // 两卡同混色
    localparam EX_WTXT  = 1513;
    localparam EX_ORNG  = 2986;
    localparam EX_DARK  = 23894;
    ...
    task check_spots; begin
        if (valid_cnt == 2) begin
            // ---- 文字带采样点(gen 打印) ----
            chk(214, 16, C_TXT_T, "W_TITLE ON");
            chk(208, 14, C_GOLDM, "W_TITLE OFF");
            chk( 88,401, C_TXT_I, "W_PLACE ON");
            chk( 85,400, C_CARDM, "W_PLACE OFF");
            chk(359,401, C_TXT_I, "W_CONT ON");
