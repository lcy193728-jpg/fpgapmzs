...
f32=ImageFont.truetype(font_path,32); f16=ImageFont.truetype(font_path,16); f24=ImageFont.truetype(font_path,24)
items=[
 ("火灾警报",(255,59,48),"告警级别：紧急","事件地点：实验楼三层","请沿东侧安全通道有序撤离","禁止乘坐电梯","🔥"),
 ("地震避险",(255,159,10),"告警级别：紧急","事件地点：实验楼三层","远离玻璃和高大物体","双手保护头部","⚠"),
 ("恶劣天气",(50,173,230),"告警级别：警告","事件地点：校园室外","暂停室外活动前往室内安全区","远离树木和高空坠物","☁"),
 ("临时疏散",(191,90,242),"告警级别：提示","事件地点：教学楼区域","按照现场人员指引有序撤离","前往东区操场集合点","➜")]
...
for n,(title,accent,level,place,action,avoid,icon) in enumerate(items):
 ...
 d.text((x0+256,y0+66),title,font=f32,fill="white");d.text((x0+78,y0+170),icon,font=ImageFont.truetype(font_path,72),fill=(255,214,10))
 ...
 d.rectangle((x0,y0+438,x0+639,y0+479),fill=(16,16,16));d.text((x0+248,y0+448),"按键四切换告警类型",font=f16,fill="white")
