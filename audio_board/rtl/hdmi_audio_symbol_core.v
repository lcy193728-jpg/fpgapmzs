...
module hdmi_audio_symbol_core #(
    ...
    // Only emit a video preamble/guard on lines that actually contain video.
    reg active_line;
    ...
    wire video_preamble = active_line && video_x >= 10'd790 && video_x <= 10'd797;
    wire video_guard = active_line && video_x >= 10'd798;
